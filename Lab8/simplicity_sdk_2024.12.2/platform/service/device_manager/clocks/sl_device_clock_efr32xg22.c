...
#if defined(_CMU_CLKEN0_EUART0_SHIFT)
// Define EUART0 peripheral bus clock value.
const uint32_t SL_BUS_CLOCK_EUART0_VALUE = (BUS_CLOCK_CLKEN0 << _BUS_CLOCK_CLKENX_SHIFT) | _CMU_CLKEN0_EUART0_SHIFT;
#endif
